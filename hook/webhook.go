...
const (
	...
	admissionWebhookAnnotationMutateKey   = "cml-engine-resources.datacreating.com/mutate"
	
	// mark the object has already mutated by  webhookserver
	// if this' value is "mutated", then do not continue mutate
	admissionWebhookAnnotationStatusKey   = "cml-engine-resources.datacreating.com/status"

	// admissionWebhookAnnotationStatusKey's value
	admissionWebhookAnnotationStatusKeyValue = "mutated"

	// add the object labels
	nameLabel      = "app.kubernetes.io/cml-engine-resources"

	instanceLabel  = "app.kubernetes.io/cml-engine-resources-instance"
...
func (whsvr *WebhookServer) mutate(ar *v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
	...
	// jiexun modify pod
	patchBytes, err := createAddResourcesContextPatch(pod, availableAnnotations, annotations, availableLabels, addLabels)
	if err != nil {
		return &v1beta1.AdmissionResponse{
			Result: &metav1.Status{
				Message: err.Error(),
